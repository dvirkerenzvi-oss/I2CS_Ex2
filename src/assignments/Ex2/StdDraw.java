package assignments.Ex2;//package stdDraw;
// https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java.html
/******************************************************************************
 *  Compilation:  javac assignments.Ex2.StdDraw.java
 *  Execution:    java assignments.Ex2.StdDraw
 *  Dependencies: none
 *
 *
...
/**
 *  The {@code assignments.Ex2.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code assignments.Ex2.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">assignments.Ex2.StdDraw.java</a>
 ...
 *           assignments.Ex2.StdDraw.setPenRadius(0.05);
 *           assignments.Ex2.StdDraw.setPenColor(assignments.Ex2.StdDraw.BLUE);
 *           assignments.Ex2.StdDraw.point(0.5, 0.5);
 *           assignments.Ex2.StdDraw.setPenColor(assignments.Ex2.StdDraw.MAGENTA);
 *           assignments.Ex2.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code assignments.Ex2.StdDraw.line()} and {@code assignments.Ex2.StdDraw.point()}
 *  draw lines and points; the methods {@code assignments.Ex2.StdDraw.setPenRadius()}
 *  and {@code assignments.Ex2.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code assignments.Ex2.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   assignments.Ex2.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code assignments.Ex2.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code assignments.Ex2.StdDraw.setPenColor(assignments.Ex2.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code assignments.Ex2.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code assignments.Ex2.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   assignments.Ex2.StdDraw.setFont(font);
 *   assignments.Ex2.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code assignments.Ex2.StdDraw.clear(assignments.Ex2.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   assignments.Ex2.StdDraw.setScale(-2, +2);
 *   assignments.Ex2.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       assignments.Ex2.StdDraw.clear();
 *       assignments.Ex2.StdDraw.filledCircle(x, y, 0.05);
 *       assignments.Ex2.StdDraw.filledCircle(-x, -y, 0.05);
 *       assignments.Ex2.StdDraw.show();
 *       assignments.Ex2.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code assignments.Ex2.StdDraw.BLACK}, {@code assignments.Ex2.StdDraw.BLUE}, {@code assignments.Ex2.StdDraw.CYAN},
	 * {@code assignments.Ex2.StdDraw.DARK_GRAY}, {@code assignments.Ex2.StdDraw.GRAY}, {@code assignments.Ex2.StdDraw.GREEN},
	 * {@code assignments.Ex2.StdDraw.LIGHT_GRAY}, {@code assignments.Ex2.StdDraw.MAGENTA}, {@code assignments.Ex2.StdDraw.ORANGE},
	 * {@code assignments.Ex2.StdDraw.PINK}, {@code assignments.Ex2.StdDraw.RED}, {@code assignments.Ex2.StdDraw.WHITE}, and
	 * {@code assignments.Ex2.StdDraw.YELLOW}.
	 *
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to assignments.Ex2.StdDraw)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to assignments.Ex2.StdDraw)
        try {
            URL url = assignments.Ex2.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
